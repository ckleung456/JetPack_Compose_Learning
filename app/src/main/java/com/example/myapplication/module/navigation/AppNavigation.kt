...
import com.example.feature.country.module.navigation.countriesDestination
...
fun AppFeatureNavigation(
    ...
    val topDestinations = topLevelDestinations(countriesDestination())
    val navigationState = rememberNavigationState(
        startRoute = CountryRoute.Countries,
        topLevelRoutes = topDestinations.keys ,
            //topLevelDestinations().keys,
